...
# for row in couch_whisks:
#     print(row)

# print(couch_whisks["whisk.system/invokerHealthTestAction0"])

# request_id = "ae146edc8f5e42af946edc8f5e22af7f"
...
if __name__ == "__main__":
    ...
    print(redis_client.hget("invocations", "test"))
    if redis_client.hget("invocations", "test") == None:
        print(True)
    else:
        print(False)
